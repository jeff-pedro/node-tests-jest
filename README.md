# Aprendendo testes com Jest

![Badge em Desenvolvimento](http://img.shields.io/static/v1?label=STATUS&message=EM%20DESENVOLVIMENTO&color=GREEN)

## Resumo do projeto

Projeto de API REST para prática de testes automatizados em JavaScript utilizando o framework **Jest**. 
Para isso é aplicado os estudos em uma API Rest de um Livraria fictícia que contém um sistema de cadastro e manejo de livros, autores,editoras e usuários.
